...
public class TherepistListAdapter extends Adapter<ViewHolder> {
    ...
    public TherepistListAdapter(List<User> resultList, Context context, boolean isRemove, OnClickListener onClickListener) {
    ...
    public TherepistListAdapter(List<User> resultList, Context context, OnClickListener onClickListener) {
        this.resultList = resultList;
        this.context = context;
        this.listener = onClickListener;
        this.isRemove = false;
    ...
    class GenericViewHolder extends ViewHolder {
        ...
        void bind(User user) {
            ...
            binding.tvAddress.setText(String.valueOf(user.getCity()));
