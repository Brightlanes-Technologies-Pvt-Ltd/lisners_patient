...
public class FavTherepistAdapter extends Adapter<ViewHolder> {
   ...
   /* public FavTherepistAdapter(List<User> resultList, Context context, boolean isRemove, OnClickListener onClickListener) {
    ...
    public FavTherepistAdapter(List<User> resultList, Context context, OnClickListener onClickListener) {
        this.resultList = resultList;
        this.context = context;
        this.listener = onClickListener;
        this.isRemove = true;
